...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY 2K ᎫISAN YT 
"""
            else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]2K ᎫISAN YT [00FF00]!!
"""
...
[FFFFFF]          ⚡ 2K ᎫISAN YT ❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]2K ᎫISAN YT    
[FFD700]✨ কেউ GUILD BOT কিনতে চাইলে WhatsApp এ message করবেন, WhatsApp  Number : 01606-746592 ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> 2K ᎫISAN YT ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "2K ᎫISAN YT", key, iv)
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]2K ᎫISAN YT
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To 2K ᎫISAN YT's BOT"
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("Initializing 2K ᎫISAN YT Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('2K ᎫISAN YTs', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 2K ᎫISAN YT BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using 2K ᎫISAN YT")
    sys.exit(0)
